...
bool LoadObjFileInternal(std::stringstream& file_string_stream,
                         std::vector<GLfloat>* out_vertices,
                         std::vector<GLfloat>* out_normals,
                         std::vector<GLfloat>* out_uv,
                         std::vector<GLushort>* out_indices, bool raw) {
...
bool LoadObjFile(const std::string& file_name, AAssetManager* asset_manager,
  ...
  return LoadObjFileInternal(file_string_stream, out_vertices, out_normals, out_uv, out_indices, raw);
}
