...
#ifndef C_ARCORE_HELLOE_AR_OBJ_WAVE_RENDERER_
#define C_ARCORE_HELLOE_AR_OBJ_WAVE_RENDERER_
#include <GLES2/gl2.h>
...
class ObjWareRenderer {
 public:
  ObjWareRenderer() = default;
  ~ObjWareRenderer() = default;
 ...
 private:
  ...
  std::vector<GLushort> line_indices_;
...
#endif  // C_ARCORE_HELLOE_AR_OBJ_WAVE_RENDERER_
